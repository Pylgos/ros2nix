...
in {
  ...
  "libboost-atomic" = [ nixpkgs.boost ];
  "libboost-atomic-dev" = [ nixpkgs.boost ];
  "libboost-chrono" = [ nixpkgs.boost ];
  "libboost-chrono-dev" = [ nixpkgs.boost ];
  "libboost-date-time" = [ nixpkgs.boost ];
  "libboost-date-time-dev" = [ nixpkgs.boost ];
  "libboost-dev" = [ nixpkgs.boost ];
  "libboost-filesystem" = [ nixpkgs.boost ];
  "libboost-filesystem-dev" = [ nixpkgs.boost ];
  "libboost-iostreams" = [ nixpkgs.boost ];
  "libboost-iostreams-dev" = [ nixpkgs.boost ];
  "libboost-math" = [ nixpkgs.boost ];
  "libboost-math-dev" = [ nixpkgs.boost ];
  "libboost-numpy-dev" = [ nixpkgs.boost ];
  "libboost-program-options" = [ nixpkgs.boost ];
  "libboost-program-options-dev" = [ nixpkgs.boost ];
  "libboost-python" = [ nixpkgs.boost ];
  "libboost-python-dev" = [ nixpkgs.boost ];
  "libboost-random" = [ nixpkgs.boost ];
  "libboost-random-dev" = [ nixpkgs.boost ];
  "libboost-regex" = [ nixpkgs.boost ];
  "libboost-regex-dev" = [ nixpkgs.boost ];
  "libboost-serialization" = [ nixpkgs.boost ];
  "libboost-serialization-dev" = [ nixpkgs.boost ];
  "libboost-system" = [ nixpkgs.boost ];
  "libboost-system-dev" = [ nixpkgs.boost ];
  "libboost-thread" = [ nixpkgs.boost ];
  "libboost-thread-dev" = [ nixpkgs.boost ];
  "libboost-timer" = [ nixpkgs.boost ];
  "libboost-timer-dev" = [ nixpkgs.boost ];
  ...
  "python3-flask-jwt-extended" = [ nixpkgs.python39Packages.flask-jwt-extended ];
  ...
  "python3-jmespath" = [ nixpkgs.python39Packages.jmespath ];
  ...
  "python3-lockfile" = [ nixpkgs.python39Packages.lockfile ];
  ...
  "python3-schema" = [ nixpkgs.python38Packages.schema ];
  ...
  "python3-tz" = [ nixpkgs.python39Packages.pytz ];
  "python3-unidiff" = [ nixpkgs.python39Packages.unidiff ];
  ...
  "python3-webargs" = [ nixpkgs.python39Packages.webargs ];
