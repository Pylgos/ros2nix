...
buildRosPackage {
  ...
  nativeBuildInputs = [  ];
  propagatedNativeBuildInputs = [ ament_cmake_python ament_cmake_ros ament_index_python fastrtps_cmake_module python3 rmw rosidl_cli rosidl_generator_c rosidl_pycommon ];
  buildInputs = [  ];
