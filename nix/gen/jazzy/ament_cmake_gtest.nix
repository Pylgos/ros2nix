...
buildRosPackage {
  ...
  nativeBuildInputs = [  ];
  propagatedNativeBuildInputs = [ ament_cmake_core ament_cmake_test gtest gtest_vendor ];
  buildInputs = [  ];
  propagatedBuildInputs = [ ament_cmake_core ament_cmake_test gtest gtest_vendor ];
  depsTargetTarget = [  ];
