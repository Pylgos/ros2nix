      ...
      substitutions = [
        {
          ...
          to = "URL ${nlohmann_json_schema_validator_vendor-vendor_source0}";
        }
      ];
    };
    nlohmann_json_schema_validator_vendor-vendor_source0 = substituteSource {
      src = fetchgit {
        name = "nlohmann_json_schema_validator_vendor-vendor_source0-source";
