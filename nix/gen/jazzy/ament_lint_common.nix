...
buildRosPackage {
  ...
  nativeBuildInputs = [  ];
  propagatedNativeBuildInputs = [ ament_cmake_core ament_cmake_cppcheck ament_cmake_cpplint ament_cmake_export_dependencies ament_cmake_flake8 ament_cmake_pep257 ament_cmake_uncrustify ];
  buildInputs = [  ];
