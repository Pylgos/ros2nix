  ...
  sources = rec {
    ouxt_lint_common = substituteSource {
      src = fetchgit {
        ...
        rev = "4d5d4e916b626b38390e84731231e2abd5835457";
...
buildRosPackage {
  ...
  propagatedNativeBuildInputs = [ ament_cmake_clang_format ament_cmake_pep257 ];
  buildInputs = [  ];
  propagatedBuildInputs = [ ament_cmake_copyright ament_cmake_xmllint ];
  depsTargetTarget = [  ];
