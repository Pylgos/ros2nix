  ...
  sources = rec {
    mola_bridge_ros2 = substituteSource {
      src = fetchgit {
        ...
        rev = "fe7a644730c3b1b5ee1ed269973d9cf5ca9f5583";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ ament_cmake_xmllint ament_lint_auto ament_lint_common geometry_msgs mola_common mola_kernel mrpt2 nav_msgs rclcpp sensor_msgs tf2 tf2_geometry_msgs ];
  depsTargetTarget = [  ];
