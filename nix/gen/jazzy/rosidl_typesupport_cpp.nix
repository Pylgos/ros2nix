...
buildRosPackage {
  ...
  nativeBuildInputs = [  ];
  propagatedNativeBuildInputs = [ ament_cmake_core ament_cmake_ros ament_index_python python3 rosidl_cli rosidl_generator_c rosidl_generator_type_description rosidl_pycommon ];
  buildInputs = [  ];
